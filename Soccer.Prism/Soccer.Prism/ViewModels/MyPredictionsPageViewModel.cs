...
namespace Soccer.Prism.ViewModels
{
    public class MyPredictionsPageViewModel : ViewModelBase
    {
        ...
        private async void LoadTournamentsAsync()
        {
            ...
            Response response = await _apiService.GetListAsync<TournametResponse>(url, "/api", "/Tournaments");
            IsRunning = false;
            ...
            List<TournametResponse> list = (List<TournametResponse>)response.Result;

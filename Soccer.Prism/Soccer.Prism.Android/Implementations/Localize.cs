...
[assembly: Dependency(typeof(Soccer.Prism.Droid.Implementations.Localize))] //implementaciòn para el SO Droid de la clase Localize
    ...
    public class Localize : ILocalize
    {
        public CultureInfo GetCurrentCultureInfo()
        {
            ...
            catch (CultureNotFoundException)
            {
                ...
                try
                {
                    string fallback = ToDotnetFallbackLanguage(new PlatfomrCulture(netLanguage));
        ...
        private string ToDotnetFallbackLanguage(PlatfomrCulture platCulture)
        {
